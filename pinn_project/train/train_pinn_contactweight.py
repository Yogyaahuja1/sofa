...
best_epoch    = 0
MODEL_BEST    = f'tissue_pinn_contactweight_n{N_LAGS}_best.pth'
...
}, f'tissue_pinn_contactweight_n{N_LAGS}_beta{SUSTAIN_BETA}.pth')
print(f"Model saved to tissue_pinn_contactweight_n{N_LAGS}_beta{SUSTAIN_BETA}.pth")

with open('contactweight_results.txt', 'a') as f:
    f.write(f"n_lags={N_LAGS:3d}  sustain_beta={SUSTAIN_BETA:.2f}  epochs_run={best_epoch:5d}  "
            ...
            f"params={n_params:,}\n")
print("Summary appended to contactweight_results.txt")
