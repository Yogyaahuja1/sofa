...
model = LagSequenceAttention(n_output=N_OUT, n_inputs=N_INPUTS).to(device)
...
best_epoch    = 0
MODEL_BEST    = 'tissue_pinn_seqattn_best.pth'
...
with torch.no_grad():
    ...
    plt.tight_layout()
    plt.savefig('sample_comparison_seqattn.png', dpi=150)
    print("\nSample comparison saved to sample_comparison_seqattn.png")
...
}, 'tissue_pinn_seqattn.pth')
print("Model saved to tissue_pinn_seqattn.pth")
...
plt.tight_layout()
plt.savefig('training_results_seqattn.png', dpi=150)
print("Plot saved to training_results_seqattn.png")
