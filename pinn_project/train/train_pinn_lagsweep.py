...
best_epoch    = 0
MODEL_BEST    = f'tissue_pinn_lagsweep_n{N_LAGS}_best.pth'
...
torch.save({
    ...
    'n_lags': N_LAGS,
}, f'tissue_pinn_lagsweep_n{N_LAGS}.pth')
print(f"Model saved to tissue_pinn_lagsweep_n{N_LAGS}.pth")

with open('lag_sweep_results.txt', 'a') as f:
    f.write(f"n_lags={N_LAGS:3d}  epochs_run={best_epoch:5d}  best_val_loss={best_val_loss:.6f}  "
            ...
            f"params={n_params:,}\n")
print("Summary appended to lag_sweep_results.txt")
